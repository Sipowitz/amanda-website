    ...
    <section className="px-6 pb-24">
      <div className="mx-auto max-w-3xl">
        ...
        >
          ...
          <h1 className="mb-8 text-5xl font-light leading-tight text-[#f1e8ca] md:text-7xl">
            Get in Touch
          </h1>

          <p className="mb-16 max-w-2xl text-lg leading-8 text-[#f1e8ca]/80">
        ...
        <div className="rounded-3xl border border-white/10 bg-black/10 p-8 backdrop-blur-md">
          ...
          <div className="space-y-4 text-lg">
            ...
            <p className="text-[#f1e8ca]/80">
              <span className="font-medium text-[#f1e8ca]">Service Area:</span>{" "}
