        ...
        <section className="px-6 py-24 sm:py-32">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="space-y-16">
              ...
              <section className="rounded-3xl border border-emerald-200/10 bg-black/10 p-8 sm:p-10 backdrop-blur-md">
                <h2 className="mb-6 text-3xl font-light text-[#f3efe7]">
                  Booking
                </h2>

                <p className="max-w-2xl text-base leading-8 text-[#ece7de] sm:text-lg">
                  Your event deserves clarity, flow, and a reader who can hold
                  the room. Submit your date request, and I’ll confirm
